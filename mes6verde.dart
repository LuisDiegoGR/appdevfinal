...
import 'evaluacionfinal.dart';

class Mes6VerdePage extends StatefulWidget {
  @override
  _Mes6VerdePageState createState() => _Mes6VerdePageState();
}

class _Mes6VerdePageState extends State<Mes6VerdePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Mes 6', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.brown.shade800)),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/images/baby_banner.png'),
                        fit: BoxFit.cover,
                      ),
                    ...
                    child: ListView(
                      children: [
                        ...
                        _buildExpansionTile(context, 'Semana 4', FontAwesomeIcons.star, [
                          ...
                          _buildNavButton(context, 'Actividad 2', ActividadesFactor1()),
                          _buildNavButton(context, 'Actividad 3', ActividadesNoche1()),
                          _buildNavButton(context, 'EVALUACIÓN FINAL', EvaluacionFinalPage(), isImportant: true),
                        ]),
                      ],
                    ),
                  ),
